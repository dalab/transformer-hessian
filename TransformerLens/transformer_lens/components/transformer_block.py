...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, cfg: Union[Dict, HookedTransformerConfig], block_index):
        ...
        # Residual scaling
        self.residual_scaling = self.cfg.residual_scaling
    ...
    def forward(
        ...
        if not self.cfg.attn_only and not self.cfg.parallel_attn_mlp:
            resid_mid = self.hook_resid_mid(self.residual_scaling * resid_pre + attn_out)  # [batch, pos, d_model]
            mlp_in = (
            ...
            resid_post = self.hook_resid_post(self.residual_scaling * resid_pre + attn_out)  # [batch, pos, d_model]
        return resid_post
